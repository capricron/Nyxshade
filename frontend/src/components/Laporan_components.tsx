                ...
                <div id="sub-report" className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        <div className="bg-gray-200 p-4 rounded-lg my-2">
                            <p>Target Name</p>
                            <h3 className="text-green-600 font-bold text-xl ">{data?.target_name}</h3>
                            <br />
                            <p>Target Address</p>
                            <h3 className="text-green-600 font-bold text-xl ">{data?.target_address}</h3>
                        </div>
                        <div id="nmap">
                            ...
                            <table className="table-auto w-full text-left border-collapse my-4">
                                ...
                                <tbody>
                                    {data.nmapData.map((item: any, index: number) => (
                                        <>
                        ...
                        <div id="Resume">
                            ...
                            <ResumeTab resume={data?.resumeData} />
                        </div>
                    </div>
                </div>
            </div>
