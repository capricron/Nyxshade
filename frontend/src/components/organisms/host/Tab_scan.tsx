      ...
      <div id="scan" className="bg-white p-4">
        {
          loading ? <Loading /> :
            (
              tab === "nmap" ? 
              <div>
                <NmapTab data={nmap_data} client:load/>
              </div>
             : tab === "nikto" ? 
              <div>
              <div className="w-2/3">
              ...
              <NiktoTab data={nikto_data} client:load/>
              </div>
              : tab === 'subfinder' ?
              <div>
                <div className="w-2/3">
              ...
              :  tab === 'resume'? 
                <div>
                <div className="w-2/3">
                  <h1 className="font-bold mb-5 mt-2">Resume ini adalah buatan AI, bisa jadi ada informasi yang salah</h1>
                </div>
